...
const MyWorld = (function () {
  ...
  function drawSun(hour) {
    ...
    ctx.globalAlpha = 0.06; fillDisc(cx, cy, r + 10, css(core));
    ctx.globalAlpha = 0.10; fillDisc(cx, cy, r + 7, css(core));
    ctx.globalAlpha = 0.15; fillDisc(cx, cy, r + 5, css(core));
    ctx.globalAlpha = 0.20; fillDisc(cx, cy, r + 3, css(core));
    ctx.globalAlpha = 0.28; fillDisc(cx, cy, r + 1, css(core));
    ctx.globalAlpha = 1;
  ...
  function drawMoon(hour) {
    ...
    ctx.globalAlpha = 0.05 * vis; fillDisc(cx, cy, r + 9, css([200, 205, 255]));
    ctx.globalAlpha = 0.08 * vis; fillDisc(cx, cy, r + 6, css([200, 205, 255]));
    ctx.globalAlpha = 0.13 * vis; fillDisc(cx, cy, r + 4, css([210, 210, 245]));
    ctx.globalAlpha = 0.19 * vis; fillDisc(cx, cy, r + 2, css([226, 220, 255]));
    ctx.globalAlpha = 0.28 * vis; fillDisc(cx, cy, r + 1, css([226, 220, 255]));
    ctx.globalAlpha = vis;

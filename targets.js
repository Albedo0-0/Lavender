// targets.js — Targets UI. Renders inside Library's right panel area is out of scope for this
// build (Library's panel is Today/Pending/History/Upcoming only, per Cleanup Item 5); Targets gets
// its own modal-driven UI, opened from Library's per-topic "Target" action button and from a
// dedicated Targets entry point wired into the existing add/manage flow below.

...
// Depends on: State, Modal, ProductivityData, GamificationData.
...
// source every poll tick, never from a cached/duplicated value.
const Gamification = (function () {
  const POLL_MS = 5000; // frequent enough to feel live without recomputing on every state change

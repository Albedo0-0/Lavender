...
const Nav = (function () {
  ...
  function switchTo(screenName) {
    ...
    if (typeof MiscSound !== 'undefined' && screenName !== prevScreen) MiscSound.play('uiNav');
    ...
    if (typeof StudyWallpaper !== 'undefined') {
      if (screenName === 'study') StudyWallpaper.resumeVideo(); else StudyWallpaper.pauseVideo();
    }

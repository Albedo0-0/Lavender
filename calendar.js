  ...
  function renderTodoList(dateStr) {
    ...
    return Object.keys(bySubject).map(function (subject) {
      ...
      return '<div class="datehub-todo-subject">' +
        '<div class="datehub-todo-subject-name section-heading">' + subject + '</div>' +
    ...
    const html =
      '<div class="datehub">' +
        '<div class="datehub-header">' +
          ...
          '<button id="datehub-close" class="datehub-close btn btn-secondary">&times;</button>' +
        '</div>' +
    ...
    function renderEventsList() {
      ...
      listEl.innerHTML = evts.length ? evts.map(function (ev, i) {
        return '<div class="datehub-event-row list-row">' + escDatehub(ev) +
          ' <button class="datehub-event-del btn btn-danger" data-idx="' + i + '">&times;</button></div>';

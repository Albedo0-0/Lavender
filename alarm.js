// alarm.js — General Alarm UI (§B.6). Depends on: State, Modal, Notify, AlarmData.
...
const Alarm = (function () {
  ...
  function poll() {
    ...
    if (due.length) showFireModal(due[0]); // one at a time; the rest catch the next poll tick
  }
